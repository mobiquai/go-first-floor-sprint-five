...
func (s Swimming) TrainingInfo() InfoMessage {
	// получаем среднюю скорость по плаванию
	meanSpeedSwimming := s.meanSpeed()

	// получаем информацию о тренировке
	info := s.Training.TrainingInfo()

	// добавляем полученную скорость в структуру с информацией о тренировке
	info.Speed = meanSpeedSwimming
